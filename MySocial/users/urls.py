...
urlpatterns = [
    ...
    path('password_change_done/',auth_view.PasswordResetDoneView.as_view(template_name='users/password_change_done.html'),name='password_change_done'),
    path('password_reset/', auth_view.PasswordResetView.as_view(template_name='users/password_reset_form.html'),name = 'password_reset'),
    path('password_reset/done',auth_view.PasswordResetDoneView.as_viewd(template_name='users/password_reset_done.html'),name='password_reset_done'),
